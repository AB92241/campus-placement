        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                   ...
                   <!-- <a class="navbar-brand page-scroll" href="http://www.cittumkur.org">Dwarkadas J. Sanghvi College of Engineering</a>-->
                </div>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    ...
                    <hr>
                    <p>"YOUR PATH TO PROFESSIONAL SUCCESS STARTS HERE"</br>We are here to Build your Skills and Career with our Driven Passion and Reality.</p>
